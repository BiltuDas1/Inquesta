          ...
          <div className="max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-2 gap-12 items-center relative z-10">
            <div className="space-y-8">
              ...
              <p className="text-lg md:text-xl text-on-surface-variant max-w-xl leading-relaxed">
                Hands-on STEM Courses for K-12 students across India. From
        ...
        <section className="py-20 bg-surface-container-low/30">
          <div className="max-w-7xl mx-auto px-8 grid grid-cols-1 md:grid-cols-4 lg:grid-cols-3 gap-12 md:gap-0">
            {[
              ...
              <div
                key={i}
                className={`text-center px-4 ${i < 3 ? "md:border-r border-outline-variant" : ""} ${i === 2 ? "lg:border-r-0" : ""} ${stat.label === "Average Rating" ? "block lg:hidden" : ""}`}
              >
                <p className="text-5xl font-headline font-extrabold text-on-surface mb-2 tracking-tighter">
                  {stat.val}
                </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
              ...
              <div className="md:col-span-8 group cursor-pointer relative h-[450px] rounded-3xl overflow-hidden bg-surface-container border border-outline-variant">
                ...
                <div className="absolute bottom-0 p-10">
                  <span className="bg-primary text-on-primary px-3 py-1 rounded-md text-xs font-bold uppercase tracking-wider mb-4 inline-block">
                    New Release
                  </span>
                  <h3 className="text-4xl font-headline font-bold mb-4">
                    Embedded Systems Engineering
                  </h3>
                  <p className="text-on-surface-variant max-w-lg mb-6 line-clamp-2">
                    Deep dive into real-time operating systems (RTOS) and the
                    architecture of power-efficient microcontroller units for
              ...
              <div className="md:col-span-4 group cursor-pointer relative h-[450px] rounded-3xl overflow-hidden bg-surface-container border border-outline-variant">
                ...
                <div className="absolute bottom-0 p-8">
                  ...
                  <p className="text-on-surface-variant text-sm mb-6">
                    Build predictive models from the ground up for edge
                ...
                <div className="relative z-10 w-full flex flex-col md:flex-row md:items-center justify-between gap-8">
                  <div className="max-w-2xl">
                    <h3 className="text-3xl font-headline font-bold mb-4">
                      Next-Gen Edge Computing Platforms
                    </h3>
                    <p className="text-on-surface-variant">
                      Deploying distributed AI at the edge to reduce latency and
                      increase security in decentralized networks.
                    </p>
                  </div>
                  <div className="flex items-center space-x-4">
                    <div className="h-16 w-16 rounded-2xl bg-surface-container-highest flex items-center justify-center border border-outline-variant">
          ...
          <div className="max-w-7xl mx-auto px-8 relative z-10">
            <div className="text-center max-w-3xl mx-auto mb-20">
              <h2 className="text-4xl md:text-5xl font-headline font-extrabold tracking-tight mb-6">
                Learn in a Digital Laboratory Environment
              </h2>
              <p className="text-on-surface-variant text-lg">
                Our proprietary platform mimics top-tier industrial R&D labs,
                giving you direct access to hardware without the overhead.
              </p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {[
                {
                  icon: "code_blocks",
                  title: "Cloud-Integrated IDE",
                  desc: "Write, compile, and deploy code directly to virtualized hardware clusters from your browser.",
                },
                {
                  icon: "view_in_ar",
                  title: "Virtual Digital Twins",
                  desc: "Interact with 1:1 digital replicas of industrial robotics and IoT sensors to test edge cases safely.",
                },
                {
                  icon: "group_work",
                  title: "Collaborative Sandboxes",
                  desc: "Pair program in real-time on complex architectural problems with peers and industry mentors.",
                },
              ].map((f, i) => (
                <div
                  key={i}
                  className="glass-card p-10 rounded-3xl border border-outline-variant hover:border-primary/30 transition-all group"
                >
        ...
        <section className="py-32 px-8">
          <div className="max-w-5xl mx-auto glass-card rounded-[3rem] p-12 md:p-20 text-center border border-primary/20 relative overflow-hidden">
            ...
            <p className="text-on-surface-variant text-xl mb-12 max-w-2xl mx-auto">
              Join the next cohort of engineers mastering the intersection of AI
