...
//   UPDATE_COURSE,
//   REQUEST_UPLOAD,
// } from "../../courses/graphql/coursesOps";
...
export default function CoursesPage() {
  ...
  // 2. Fetch Teachers
  const { data: teachersData } = useQuery<GetTeachersResponse>(GET_TEACHERS_QUERY, {
    fetchPolicy: "cache-first",
  });
  
  const teachersList = teachersData?.getTeachers?.data || [];
