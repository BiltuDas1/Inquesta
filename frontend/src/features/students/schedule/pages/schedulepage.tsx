...
export default function SchedulePage() {
  const scheduleData: ClassSession[] = useMemo(
    () => [
      { id: "1", subject: "Assembly", day: "Monday", startHour: 8, durationHours: 1, colorClass: "bg-[#8774e1] text-white" },
      { id: "2", subject: "Mathematics", day: "Monday", startHour: 9, durationHours: 1, colorClass: "bg-[#1e619b] text-white" },
      { id: "3", subject: "English", day: "Monday", startHour: 11, durationHours: 1, colorClass: "bg-[#396d13] text-white" },
      { id: "4", subject: "Science", day: "Tuesday", startHour: 9, durationHours: 1, colorClass: "bg-[#12684e] text-white" },
      { id: "5", subject: "History", day: "Tuesday", startHour: 12, durationHours: 1, colorClass: "bg-[#814e13] text-white" },
      { id: "6", subject: "Mathematics", day: "Wednesday", startHour: 9, durationHours: 1, colorClass: "bg-[#1e619b] text-white" },
      { id: "7", subject: "Art", day: "Wednesday", startHour: 10, durationHours: 1, colorClass: "bg-[#8c3558] text-white" },
      { id: "8", subject: "PE", day: "Wednesday", startHour: 13, durationHours: 1, colorClass: "bg-[#5f5f5f] text-white" },
      { id: "9", subject: "Science", day: "Thursday", startHour: 9, durationHours: 1, colorClass: "bg-[#12684e] text-white" },
      { id: "10", subject: "English", day: "Thursday", startHour: 11, durationHours: 1, colorClass: "bg-[#396d13] text-white" },
      { id: "11", subject: "Mathematics", day: "Friday", startHour: 8, durationHours: 1, colorClass: "bg-[#1e619b] text-white" },
      { id: "12", subject: "History", day: "Friday", startHour: 10, durationHours: 1, colorClass: "bg-[#814e13] text-white" },
      { id: "13", subject: "Free period", day: "Friday", startHour: 12, durationHours: 1, colorClass: "bg-[#a6a6a6] text-gray-900" },
    ],
    []
  );
  ...
  return (
    ...
    <div className="absolute inset-0 p-4 sm:p-6 lg:p-8 flex flex-col bg-[#10141a]">
      ...
      <div className="mb-6 shrink-0">
        <h1 className="text-3xl font-headline font-bold text-[#dfe2eb]">Schedule</h1>
        <p className="text-[#84948e] mt-1 font-body">Your full weekly class timetable</p>
      </div>
