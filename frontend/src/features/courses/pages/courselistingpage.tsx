...
// // New query for searching courses
// const SEARCH_COURSES = gql`
//   query searchCourses($lastID: String, $lastRelevance: Float, $limit: Int!, $text: String!) {
//     searchCourses(lastID: $lastID, lastRelevance: $lastRelevance, limit: $limit, text: $text) {
//     data {
//         id
//         title
//         description
...
//   searchCourses: SearchableCourse[];
// }
...
//   const [lastRelevance, setLastRelevance] = useState<string | null>(initialCursorRel);
//   const [page, setPage] = useState<number>(initialPage);

//   // History now tracks BOTH ID and Relevance so we can navigate backwards accurately during search
//   const [cursorHistory, setCursorHistory] = useState<{ id: string | null; rel: string | null }[]>([]);
...
//   // --- 2. URL Update Helper ---
//   const updateURL = (newPage: number, newID: string | null, newRel: string | null = null) => {
//     const url = new URL(window.location.href);
//     url.searchParams.set("p", newPage.toString());
...
//   // --- 3. Conditional GraphQL Execution ---

//   // A: Default Query (Runs if NO search query exists)
//   const {
...
//   // B: Search Query (Runs if search query DOES exist)
//   const {
...
//       limit: "12",
//       lastID: lastID || "null",
//       lastRelevance: lastRelevance || "0.0",
//     },
...
//   const appError = !searchQuery && defaultData?.courseGet?.success === false
...
//       const newCursorRel = lastItem.relevance ? lastItem.relevance.toString() : "0.0";
...
//             {/* The Ghost Page Fallback UI (Exactly as original) */}
//             {!loading && !error && !appError && displayCourses.length === 0 && (
//               <div className="flex flex-col items-center justify-center py-16">
//                 <span className="material-symbols-outlined text-[#84948e] text-5xl mb-4">
//                   inventory_2
