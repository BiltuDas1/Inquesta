...
import { useState, useEffect, useRef } from "react";
import { Logo } from "./logo";
import { useNavigate, Link } from "react-router"; // Ensure this matches your routing library (react-router or react-router-dom)
import { useAuth } from "../../features/auth/context/authcontext";

export default function Navbar() {
  // 1. ADDED: State to track the search input text
