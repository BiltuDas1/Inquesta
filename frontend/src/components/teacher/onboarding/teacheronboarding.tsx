...
export default function TeacherOnboarding() {
  ...
  // 3. Apollo Hooks
  const { data: inviteData, loading: isLoadingInvite } =
    useQuery<GetTeacherInviteResponse>(GET_TEACHER_INVITE_QUERY, {
      variables: { teacherId },
      skip: !teacherId, // Don't run the query until we have the ID
    });

  const [completeSetup, { loading: isSaving }] =
    useMutation<CompleteOnboardingResponse>(COMPLETE_ONBOARDING_MUTATION);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.data?.addedTeacherDetails?.success) {
        ...
        toast.error(
          response.data?.addedTeacherDetails?.message || "Setup failed.",
          {
            style: {
              background: "#1c2026",
              color: "#ffb4ab",
    ...
    return (
      <div className="min-h-screen bg-[#10141a] flex items-center justify-center p-4">
        <div className="bg-[#1c2026] border border-[#3b4a44] p-8 rounded-2xl text-center max-w-md w-full">
          <span className="material-symbols-outlined text-5xl text-[#ffb4ab] mb-4">
            link_off
          </span>
          <h1 className="text-xl font-bold text-[#dfe2eb] mb-2">
            Invalid Invitation Link
          </h1>
          <p className="text-[#84948e]">
            We couldn't find your setup ID. Please check the link in your email
            and try again.
          </p>
        </div>
      </div>
    ...
    <div className="min-h-screen bg-[#10141a] font-body text-[#dfe2eb] flex flex-col items-center justify-center p-4 sm:p-6 lg:p-8">
      ...
      <div className="mb-8 text-center animate-in fade-in slide-in-from-bottom-4 duration-500">
        ...
        <p className="text-[#84948e] mt-2 max-w-sm mx-auto">
          Welcome to Luminary! Please confirm your details and set a password to
      ...
      <div className="w-full max-w-2xl bg-[#1c2026] border border-[#3b4a44] rounded-2xl shadow-2xl overflow-hidden flex flex-col animate-in fade-in zoom-in-95 duration-700">
        {isLoadingInvite ? (
          <div className="p-12 flex flex-col items-center justify-center">
            <span className="material-symbols-outlined animate-spin text-[40px] text-[#6fffd9] mb-4">
              progress_activity
            </span>
          ...
          >
            ...
            <div className="p-6 sm:p-8 overflow-y-auto custom-scrollbar space-y-6">
              ...
              <div className="space-y-4">
                <h3 className="text-sm font-semibold text-[#6fffd9] uppercase tracking-wider">
                  Personal Information
                </h3>

                <div className="flex flex-col sm:flex-row gap-4">
                  <div className="flex-1 space-y-1.5">
                    <label className="text-sm font-semibold text-[#b9cac3]">
                      First Name
                    </label>
                    <input
                      readOnly
                ...
                <div className="space-y-1.5">
                  ...
                  <p className="text-xs text-[#84948e] mt-1">
                    Your name and email were set by your administrator.
                  </p>
                </div>
              </div>
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-1.5">
                  <label
                    ...
                    className="text-sm font-semibold text-[#b9cac3]"
                  >
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  <div className="flex-1 space-y-1.5">
                    <label
                      ...
                      className="text-sm font-semibold text-[#b9cac3]"
                    >
                      Create Password <span className="text-[#ffb4ab]">*</span>
                    </label>
                    <input
                      id="password"
                      required
                  ...
                  <div className="flex-1 space-y-1.5">
                    <label
                      ...
                      className="text-sm font-semibold text-[#b9cac3]"
                    >
                      Confirm Password <span className="text-[#ffb4ab]">*</span>
                    </label>
                    <input
                      id="confirmPassword"
                      required
