...
// Make sure this matches the interface in the parent component
interface Teacher {
  id: string;
  firstname: string;
...
interface ModalProps {
  editing: (Course & { assignedTeacher?: string }) | null;
  onClose: () => void;
  onSave: (data: any, file: File | null) => void;
  isSubmitting: boolean;
  teachers: Teacher[]; // <--- Require the array of teacher objects
}
      ...
      >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          <div className="space-y-4">
            ...
            {/* ── Updated Dynamic Assign Teacher Dropdown Field ── */}
            <div>
              ...
              >
                ...
                {/* Now mapping through dynamic teacher objects */}
                {teachers.map((teacher) => (
                  <option key={teacher.id} value={teacher.id} className="bg-[#1c2026]">
