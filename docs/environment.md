...
| `SUPERBASE_S3_ENDPOINT`          | The endpoint of the S3 Protocol                                                                  | :white_check_mark: |
| `SUPERBASE_S3_PUBLIC_ENDPOINT`   | The public endpoint where the files can be accessed pubically                                    | :white_check_mark: |
| `SUPERBASE_S3_ACCESS_KEY`        | S3 Access Key                                                                                    | :white_check_mark: |
| `SUPERBASE_S3_SECRET_ACCESS_KEY` | S3 Secret Access Key                                                                             | :white_check_mark: |
